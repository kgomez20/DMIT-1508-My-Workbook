...
SELECT  AVG(Mark) AS 'Average Mark'    -- We meed to give the column an alias/title
FROM    Registration
...
SELECT  * FROM Staff
SELECT  COUNT(DateReleased) AS 'Retired Staff'  -- Note that this COUNT() igrnored the NULL values
FROM    Staff
